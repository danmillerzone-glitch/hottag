          ...
          <div className="relative w-full max-w-lg bg-background-secondary rounded-2xl border border-border shadow-2xl max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between p-6 border-b border-border">
              <div>
                ...
                <p className="text-sm text-foreground-muted mt-1">Verify that you are this wrestler</p>
              </div>
            ...
            {codeSuccess ? (
              <div className="p-6 text-center">
                ...
                <p className="text-foreground-muted mb-6">You now have full access to your wrestler dashboard.</p>
                <button onClick={() => window.location.href = '/dashboard/wrestler'} className="btn btn-primary">Go to Dashboard</button>
              </div>
            ) : success ? (
              <div className="p-6 text-center">
                <div className="w-16 h-16 rounded-full bg-attending/20 flex items-center justify-center mx-auto mb-4">
              ...
              <>
                ...
                {tab === 'code' ? (
                  ...
                  <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium mb-1.5">Ring Name</label>
                      <input type="text" value={ringName} onChange={(e) => setRingName(e.target.value)} placeholder={wrestlerName}
                        className="w-full px-3 py-2.5 rounded-lg bg-background-tertiary border border-border text-foreground placeholder:text-foreground-muted/50 focus:border-accent focus:ring-1 focus:ring-accent outline-none transition-colors" />
                    </div>
                    <div>
